...
```TypeScript
import { mockFirebase } from '@upptacka/firestore-jest-mock';
```
...
```js
const { mockGoogleCloudFirestore } = require('@upptacka/firestore-jest-mock');
...
```js
const { mockReactNativeFirestore } = require('@upptacka/firestore-jest-mock');
